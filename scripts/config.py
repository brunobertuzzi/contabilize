...
class Config:
    ...
    if not DEFAULT_ADMIN_PASSWORD:
        if DEBUG or TESTING:
            DEFAULT_ADMIN_PASSWORD = 'admin'  # Valor padrão para desenvolvimento - ALTERE EM PRODUÇÃO
        else:
            raise ValueError("DEFAULT_ADMIN_PASSWORD deve ser definido em produção")
