...
def settings():
    try:
        ...
        return jsonify({'success': False, 'message': f"Erro interno ao carregar configurações: {str(e)}"}), 500
        ...
        with get_db() as db:
            ...
            if new_password:
                if new_password != confirm_new_password:
                    return jsonify({'success': False, 'message': 'A nova senha e a confirmação da nova senha não coincidem.'}), 400
